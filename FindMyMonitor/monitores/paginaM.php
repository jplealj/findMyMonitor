...
<form action="../monitores/diaNuevoM.php" method="post">
<br>
    <input type="hidden" name="id" placeholder="Codigo" value="<?php echo $fila['id'] ?>">
    <input type="submit" value="Añadir dia">
</form>

<form action="../monitores/actualizar.php" method="post">
...
<table class="table table-striped">
    ...
    <?php
        $sel=$con->query("SELECT * FROM monitores INNER JOIN horario ON monitores.id=horario.id WHERE monitores.id=$id");
    ...
    <tr>
        ...
        <td><a href="../monitorback/borrar.php?id=<?php echo $fila['id']?>&dias=<?php echo $fila['dias']?>&horaInicio=<?php echo $fila['horaInicio']?>&horaFinal=<?php echo $fila['horaFinal']?>">Borrar</a></td>
    </tr>

        <?php } ?>
      
</table>
<form action="../monitorback/logout.php" method="post">
<br>
